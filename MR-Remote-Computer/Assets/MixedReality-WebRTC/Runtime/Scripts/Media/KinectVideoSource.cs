...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    /// </summary>
    public class KinectVideoSource : CustomVideoSource<Argb32VideoFrameStorage>
    {
        /// <summary>
        ...
        private byte[] _data = new byte[FrameSize*4];
        public void setData(byte[] data) { _data = data; }

        private int _index = -2;
        //public const bool renderColor = true;
        ...
        protected override void OnFrameRequested(in FrameRequest request)
        {
            ...
            unsafe
            {
                fixed (void* ptr = _data)
                {
                    ...
                    frame.data = new IntPtr(ptr); // like in SceneVideoSource.cs
