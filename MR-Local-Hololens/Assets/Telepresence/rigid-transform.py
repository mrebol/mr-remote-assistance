...
import json
# Opening JSON file
f = open('D:\\repos\\telehealth\MR-Local\Assets\Telepresence\Data.json', )
...
if(numberOfCameras == 1):
    with open('D:\\repos\\telehealth\MR-Local\Assets\Telepresence\Transformation-Camera.json', 'w') as outfile:
        json.dump(data, outfile)
elif(numberOfCameras == 2):
    with open('D:\\repos\\telehealth\MR-Local\Assets\Telepresence\Transformation-View.json', 'w') as outfile:
        json.dump(data, outfile)