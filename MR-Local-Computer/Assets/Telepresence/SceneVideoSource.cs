...
namespace Telepresence
{
    ...
    public class SceneVideoSource : CustomVideoSource<Argb32VideoFrameStorage>
    {
        ...
        protected override void OnFrameRequested(in FrameRequest request)
        {
            ...
            if (colorData.ColorPackets != null && colorData.ColorPackets.Count > 0)
            {

                byte[] colorPacket = colorData.ColorPackets.Dequeue();
                    ...
                    var frame = new Argb32VideoFrame
                    {
                        ...
                        stride = (int) ColorData.Width * 4
                    };
                    unsafe
                    {
                        fixed (void* ptr = colorPacket)
                        {
