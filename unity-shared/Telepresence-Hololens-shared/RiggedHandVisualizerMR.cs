...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    /// </summary>
    public class RiggedHandVisualizerMR : MonoBehaviour, IMixedRealityControllerVisualizer, IMixedRealitySourceStateHandler, IMixedRealityHandJointHandler
    {
...
#if UNITY_EDITOR
            if (
                !UnityEngine.Input.GetKey(KeyCode.Space)&&isRightHand || 
                !UnityEngine.Input.GetKey(KeyCode.LeftShift)&&!isRightHand)
            {
                return;
            }
            #endif
                    ...
                    if (joints.TryGetValue(handJoint, out jointTransform))
                    {
                        if (jointTransform != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (ScaleLastFingerBone &&  // Not enabled
