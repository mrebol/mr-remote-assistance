...
namespace Microsoft.MixedReality.WebRTC.Unity.Editor
{
    ...
    public class PeerConnectionEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty peerName_;
        SerializedProperty dataChannelName_;
        SerializedProperty webRtcManager_;
        SerializedProperty trackerCamerCube_;
        ...
        void OnEnable()
        {
            peerName_ = serializedObject.FindProperty("PeerName");
            dataChannelName_ = serializedObject.FindProperty("DataChannelName");
            webRtcManager_ = serializedObject.FindProperty("WebRTCManager");
            trackerCamerCube_ = serializedObject.FindProperty("TrackerCameraCube");
...
#endif
            EditorGUILayout.PropertyField(peerName_);
            EditorGUILayout.PropertyField(dataChannelName_);
            EditorGUILayout.PropertyField(webRtcManager_);
            //EditorGUILayout.PropertyField(trackerCamerCube_);
